    ...
    <div id="calendar-container">
        ...
        <div id="calendar-footer">
          <div class="btn">
            ...
            ?><a href="javascript:move('<?php echo(str_pad($previous_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($previous_year);?>');">&lt; Forrige</a><?php
            }else echo("&nbsp;");
            ?>
            </div>
            ...
            ?><a href="javascript:move('<?php echo(str_pad($next_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($next_year);?>');">Neste &gt;</a><?php
            }else echo("&nbsp;");
            ?>
            </div>
