...
require_once('class.rapport.tellercollection.php');
...
abstract class msmodul_rapport implements msmodul{
    ...
    public function registrer_meny(MenyitemCollection &$meny){
        ...
        if ($lvl > MSAUTH_NONE) { 
            ...
            $toppmeny = new Menyitem('Base Rapport','&amp;page=rapport');
            ...
            if (isset($act) && array_search('notoc', (array) $this->_msmodulvars) === false) {
                $telleradmin = new Menyitem('Rediger tellere','&amp;page=rapport&amp;act=telleradm');
                $genrapport = new Menyitem('Lag rapport','&amp;page=rapport&amp;act=genrapportsel');
                $rapportarkiv = new Menyitem('Rapportarkiv','&amp;page=rapport&amp;act=rapportarkiv');
                $tpladmin = new Menyitem('Rapporttemplates','&amp;page=rapport&amp;act=genmodraptpl');
